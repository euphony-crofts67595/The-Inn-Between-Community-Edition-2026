...
# 🎮 The Inn Between — Community Edition

**Standalone Community Edition of the atmospheric inn mystery adventure.**
...
The Inn Between is a first-person narrative adventure set in a mysterious inn where every guest carries a story waiting to be uncovered. This Community Edition is a standalone build distributed as a self-contained package, requiring no storefront or additional software. It includes all content of the independent release and is ready to play immediately after installation. The offline version runs entirely without an internet connection.

Players who want a self-contained offline Community Edition of this story-rich indie adventure on Windows PC.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1776200/ss_c27d7ed3e11a62eb3576aa15445f32d16f7f41b2.1920x1080.jpg?t=1788217236" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1776200/31d74d7e8eb5f362b830dc8b34d3326e2d965678/ss_31d74d7e8eb5f362b830dc8b34d3326e2d965678.1920x1080.jpg?t=1788217236" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1776200/ss_ec9e11420d59e87707d9ca1438f7286b0da0de79.1920x1080.jpg?t=1788217236" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🏨 **Atmospheric Inn Setting** — Explore a handcrafted inn filled with secrets, rooms, and guests.
- 🧩 **Environmental Puzzles** — Solve observation-based puzzles woven into the narrative.
- 📖 **Story-Driven Mystery** — Unravel the interconnected stories of the inn's visitors.
- 🎨 **Stylized Visuals** — Distinctive art direction with a moody, cinematic palette.
- 🔊 **Original Soundtrack** — Ambient score that adapts to the tone of each scene.
- 💾 **Self-Contained Package** — All game data ships in one folder — no external dependencies.
- 🔌 **Full Offline Play** — Runs completely offline; no account or network connection needed.
- 🖥️ **Ready to Play** — Includes all content — launch directly after installation.
...
| **Additional** | DirectX 11 compatible sound card | Headphones recommended for full audio experience |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\TheInnBetween\Saved`
